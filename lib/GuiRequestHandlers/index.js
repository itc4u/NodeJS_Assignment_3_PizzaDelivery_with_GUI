...
class Handlers {
    ...
    // Serve the menu and cart on the same page for authenticated users
    static async menusWithCart(data) {
        return await unifiedGuiHandler(data, {
            'head.title' : 'Gourmet Menu | Chief\'s Recommendation',
            'head.description' : 'Awesome Menus, Awesome Pizzas',
            'body.class' : 'menusListAuthenticated'
        }, "menusListAuthenticated");
    }

    // Fake Credit Card Charging Page
    static async confirmPayment(data) {
        return await unifiedGuiHandler(data, {
            'head.title' : 'Checkout | Please Confirm Your Payment',
            'head.description' : 'Please confirm your credit card detail',
            'body.class' : 'confirmPayment'
        }, "confirmPayment");
    }

    // Display all past transactions
    static async ordersList(data) {
        return await unifiedGuiHandler(data, {
            'head.title' : 'Orders | View All Your Transactions Record',
            'head.description' : 'View All Your Transactions Record',
